...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        {
            // TODO: Buscar o Id no banco utilizando o EF e Validar o tipo de retorno. Se não encontrar a tarefa, retornar NotFound,
        ...
        public IActionResult Atualizar(int id, Tarefa tarefa)
        {
            ...
            //Atualizar as informações da variável tarefaBanco com a tarefa recebida via parâmetro e Atualizar a variável tarefaBanco no EF e salvar as mudanças (save changes)
